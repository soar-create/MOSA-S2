...
class AttackedText:
    ...
    @property
    def premisetext(self):
        return self._text_input["premise"]
    
    @property
    def premisewords(self):
        if not self._premisewords:
            self._premisewords = words_from_text(self.premisetext)
        return self._premisewords
    @property
    def hypothesistext(self):
        return self._text_input["hypothesis"]
    
    @property
    def hypothesiswords(self):
        if not self._hypothesiswords:
            self._hypothesiswords = words_from_text(self.hypothesistext)
        return self._hypothesiswords
