...
HUGGINGFACE_DATASET_BY_MODEL = {
    ...
    # bert-base-uncased
    #
    "bert-base-uncased-ag-news": ("ag_news", None, "train"),
    ...
    "bert-base-uncased-mrpc": ("glue", "mrpc", "train"),
    "bert-base-uncased-qnli": ("glue", "qnli", "train"),
    "bert-base-uncased-qqp": ("glue", "qqp", "train"),
    "bert-base-uncased-rte": ("glue", "rte", "train"),
    "bert-base-uncased-sst2": ("glue", "sst2", "train"),
    ...
    "bert-base-uncased-mr": ("rotten_tomatoes", None, "train"),
    "bert-base-uncased-snli": ("snli", None, "train", None, {0: 1, 1: 2, 2: 0}),
    "bert-base-uncased-yelp": ("yelp_polarity", None, "train"),
    #
    # distilbert-base-cased
    #
    "distilbert-base-cased-cola": ("glue", "cola", "validation"),
    "distilbert-base-cased-mrpc": ("glue", "mrpc", "train"),
    "distilbert-base-cased-qqp": ("glue", "qqp", "train"),
    "distilbert-base-cased-snli": ("snli", None, "train"),
    "distilbert-base-cased-sst2": ("glue", "sst2", "train"),
    ...
    "distilbert-base-uncased-mr": ("rotten_tomatoes", None, "train"),
    "distilbert-base-uncased-mrpc": ("glue", "mrpc", "train"),
    "distilbert-base-uncased-qnli": ("glue", "qnli", "train"),
    "distilbert-base-uncased-rte": ("glue", "rte", "train"),
    ...
    "roberta-base-mrpc": ("glue", "mrpc", "train"),
    "roberta-base-qnli": ("glue", "qnli", "train"),
    "roberta-base-rte": ("glue", "rte", "train"),
    "roberta-base-sst2": ("glue", "sst2", "train"),
    ...
    "albert-base-v2-rte": ("glue", "rte", "train"),
    "albert-base-v2-qqp": ("glue", "qqp", "train"),
    "albert-base-v2-snli": ("snli", None, "train"),
    "albert-base-v2-sst2": ("glue", "sst2", "train"),
    ...
    "xlnet-base-cased-mr": ("rotten_tomatoes", None, "train"),
    "xlnet-base-cased-mrpc": ("glue", "mrpc", "train"),
    "xlnet-base-cased-rte": ("glue", "rte", "train"),
