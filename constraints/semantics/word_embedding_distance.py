...
from textattack.shared.word_embeddings import AbstractWordEmbedding, WordEmbedding
...
class WordEmbeddingDistance(Constraint):
    ...
    def check_compatibility(self, transformation):
        ...
        return  validators.transformation_consists_of_word_swaps(transformation)
